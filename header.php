  ...
  <img src="images/logo.jpg" style="width:75px;height:50px;display: inline-block">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
       <li><a href="schema.php">My Schemas</a></li>
        <li class="dropdown">
          <a class="dropdown-toggle" role="button" aria-expanded="true" href="#" data-toggle="dropdown">Services <span class="caret"></span></a>
          <ul class="dropdown-menu" role="menu">
            <li><a href="add_schema.php">Add Schema</a></li>
            <li><a href="update_sch.php">Update Schema</a></li>
            <li><a href="questions.php">Post Question</a></li>
            <li><a href="queries.php">My Queries</a></li>
          </ul>
        </li>
      </ul>
